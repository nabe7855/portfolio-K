  ...
  return (
    <div className="pt-32">
      ...
      <section className="max-w-7xl mx-auto px-6 mb-32">
        <Link
          to="/works"
          className="text-[10px] font-bold tracking-[0.4em] text-gray-400 mb-20 block hover:text-blue-600 uppercase transition-colors"
        >
        ...
        <div className="flex flex-col md:flex-row justify-between items-end gap-16">
          <div className="md:w-3/4">
            ...
            <h1 className="text-6xl md:text-[8rem] font-serif-display font-bold leading-none italic -ml-2">
              {work.title[lang]}
            </h1>
          </div>
          <div className="md:w-1/4 flex gap-3 flex-wrap justify-end">
            {work.tech.map((t) => (
              <span
                key={t}
                className="px-5 py-2 bg-gray-50 border border-gray-100 text-[9px] tracking-[0.2em] font-bold uppercase rounded-full text-gray-500"
              >
                {t}
              </span>
            ))}
      ...
      <section className="max-w-5xl mx-auto px-6 mb-60">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-24 mb-48 border-y border-gray-100 py-20">
          <div className="space-y-6">
            <h3 className="text-[10px] font-bold tracking-[0.4em] uppercase text-blue-600">
              Background
            </h3>
            <p className="text-gray-600 font-serif-jp leading-relaxed">
              {work.background[lang]}
            </p>
          </div>
          <div className="space-y-6">
            <h3 className="text-[10px] font-bold tracking-[0.4em] uppercase text-blue-600">
          ...
          <div className="space-y-6">
            ...
            <p className="text-gray-900 font-serif-jp leading-relaxed font-bold text-lg">
              {work.result[lang]}
            </p>
          </div>
        </div>
        ...
        <div className="space-y-40">
          <div className="max-w-3xl">
            <h2 className="text-5xl md:text-7xl font-serif-display italic mb-12 leading-tight">
              Crafting the <br /> Solution.
            </h2>
