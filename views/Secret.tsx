    ...
    <div className="pt-48 pb-32 min-h-screen bg-[#0A0A0A] text-white">
      <div className="max-w-7xl mx-auto px-6">
        <header className="mb-32">
          ...
          <h1 className="text-7xl md:text-9xl font-serif-display italic mb-12">
            Exclusive.
          </h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-20">
          <div className="bg-white/5 border border-white/10 p-12 hover:bg-white/10 transition-all">
            <h3 className="text-xs font-bold tracking-[0.4em] text-blue-400 mb-8 uppercase">
              Blueprints
            </h3>
            <h4 className="text-3xl font-serif-jp font-bold mb-6">
              Gemini-Edge Architecture v2
            </h4>
            ...
            <div className="aspect-video bg-black/40 border border-white/5 mb-8 flex items-center justify-center">
              <span className="text-[10px] tracking-widest text-gray-600 uppercase font-bold">
                [ Confidential Visual ]
              </span>
            </div>
            <button className="text-[10px] tracking-[0.4em] font-bold uppercase border-b border-blue-400 pb-1 hover:text-blue-400">
              Download Schema
            </button>
          </div>
        ...
        <section className="mt-40">
          <h2 className="text-xs tracking-[0.6em] font-bold text-gray-500 mb-16 uppercase text-center">
            Private Sketchbook
          </h2>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {[1, 2, 3, 4].map((i) => (
              <div
                key={i}
                className="aspect-square bg-white/5 grayscale hover:grayscale-0 transition-all cursor-pointer group relative overflow-hidden"
              >
                <img
