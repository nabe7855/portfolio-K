  ...
  return (
    <div className="pt-48 pb-32 min-h-screen">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <h1 className="text-7xl md:text-9xl font-serif-display italic mb-24 -ml-1">Journal.</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-16">
          {JOURNAL_ENTRIES.map((entry) => (
            ...
            >
              ...
              <p className="text-[10px] font-bold text-gray-400 mb-4 tracking-[0.2em] uppercase">{entry.date}</p>
              ...
              <div className="flex gap-4">
                {entry.tags.map(tag => (
                  <span key={tag} className="text-[9px] font-bold tracking-widest text-gray-300 uppercase">#{tag}</span>
                ))}
              </div>
            </Link>
          ))}
