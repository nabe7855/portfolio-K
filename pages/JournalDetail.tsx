    ...
    <div className="pt-48 pb-32">
      <article className="max-w-4xl mx-auto px-6">
        ...
        <header className="mb-24">
          <p className="text-xs font-bold tracking-[0.3em] text-blue-600 mb-8 uppercase">
            {entry.date}
          </p>
          ...
          <div className="flex gap-4 flex-wrap">
            {entry.tags.map((tag) => (
              <span
                key={tag}
                className="px-4 py-1 border border-gray-200 text-[10px] font-bold tracking-widest text-gray-400 uppercase rounded-full"
              >
                {tag}
              </span>
            ))}
        ...
        <footer className="mt-32 pt-20 border-t border-gray-100">
          <h4 className="text-xs font-bold tracking-widest text-gray-300 uppercase mb-8 text-center">
            Share Perspective
          </h4>
