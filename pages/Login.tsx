  ...
  return (
    <div className="pt-48 pb-32 min-h-screen bg-[#F8F9FA] flex items-center justify-center">
      <div className="max-w-md w-full px-6">
        ...
        <form onSubmit={handleSubmit} className="bg-white p-12 shadow-2xl rounded-sm border border-gray-100">
          <div className="space-y-8 mb-12">
            <div className="border-b border-gray-200 py-4 focus-within:border-blue-600 transition-colors">
              <label className="block text-[8px] font-bold tracking-widest text-gray-400 uppercase mb-2">Identifier</label>
              <input 
                type="text" 
                value={user}
            ...
            <div className="border-b border-gray-200 py-4 focus-within:border-blue-600 transition-colors">
              <label className="block text-[8px] font-bold tracking-widest text-gray-400 uppercase mb-2">Access Key</label>
              <input 
                type="password" 
                value={pass}
